...
//Authorization
const {checkTokenAuthorization} = require('../authorization/tokenAuthorizationModel');
...
module.exports = (router, app) => {
    router.post('/createTimeBasedAutomation',checkTokenAuthorization,c(automationController.createTimeBasedAutomation, (req,res,next) => [res.locals.userId, req.body.groupId, req.body.automationName, req.body.triggerDeviceId, req.body.triggerDeviceDataType, req.body.triggerDeviceValue, req.body.triggerDeviceCondition, req.body.sceneId]));
    ...
    router.post('/createConditionBasedAutomation',checkTokenAuthorization,c(automationController.createConditionBasedAutomation, (req,res,next) => [req.body.groupId]));
    router.post('/fetchGroupAutomations',checkTokenAuthorization,c(automationController.fetchGroupAutomations, (req,res,next) => [req.body.groupId]));
    router.post('/v2/fetchGroupAutomations',checkTokenAuthorization,c(automationController.fetchGroupAutomationsV2, (req,res,next) => [req.body.groupId]));    
